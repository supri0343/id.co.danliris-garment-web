...
namespace Manufactures.Tests.CommandHandlers.GarmentDeliveryReturns.CommandHandlers
{
    public class RemoveGarmentDeliveryReturnCommandHandlerTest : BaseCommandUnitTest
    {
        ...
        public async Task Handle_StateUnderTest_ExpectedBehavior()
        {
            ...
            GarmentPreparingItem garmentPreparingItem = new GarmentPreparingItem(id, 1, new Domain.GarmentPreparings.ValueObjects.ProductId(1), "productCode", "productName", "designColor", 1, new Domain.GarmentPreparings.ValueObjects.UomId(1), "uomUnit", "FABRIC", 1, 1, id,null, "bcno", "bctype", DateTime.Now);
