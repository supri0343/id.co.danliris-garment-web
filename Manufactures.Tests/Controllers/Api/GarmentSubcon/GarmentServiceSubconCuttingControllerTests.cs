    ...
    public class GarmentServiceSubconCuttingControllerTests : BaseControllerUnitTest
    {
        ...
        public async Task Get_StateUnderTest_ExpectedBehavior()
        {
            ...
            _mockGarmentServiceSubconCuttingRepository
                ...
                {
                    new GarmentServiceSubconCutting(ServiceSubconCuttingGuid, null, null, new UnitDepartmentId(1), null, null,  DateTimeOffset.Now, false, new BuyerId(1), null, null, new UomId(1), null, 0, 0, 0, null)
                });
        ...
        public async Task GetSingle_StateUnderTest_ExpectedBehavior()
        {
            ...
            _mockGarmentServiceSubconCuttingRepository
                ...
                .Returns(new List<GarmentServiceSubconCutting>()
                {
                    new GarmentServiceSubconCutting(Guid.NewGuid(), null, null, new UnitDepartmentId(1), null, null, DateTimeOffset.Now, false, new BuyerId(1), null, null, new UomId(1), null, 0, 0, 0, null)
                });
        ...
        public async Task Post_StateUnderTest_ExpectedBehavior()
        {
            ...
            _MockMediator
                ...
                .ReturnsAsync(new GarmentServiceSubconCutting(Guid.NewGuid(), null, null, new UnitDepartmentId(1), null, null, DateTimeOffset.Now, false, new BuyerId(1), null, null, new UomId(1), null, 1, 1, 1, null));
        ...
        public async Task Put_StateUnderTest_ExpectedBehavior()
        {
            ...
            _MockMediator
                ...
                .ReturnsAsync(new GarmentServiceSubconCutting(Guid.NewGuid(), null, null, new UnitDepartmentId(1), null, null, DateTimeOffset.Now, false, new BuyerId(1), null, null, new UomId(1), null, 0, 0, 0, null));
