...
namespace Manufactures.Tests.ExcelTemplates
{
    public class GarmentSubconContractExcelTemplateTests
    {
        ...
        public void Generate_Return_Success()
        {
            ...
            var id = Guid.NewGuid();
            var subconContract = new GarmentSubconContract(id, "", "", "", new SupplierId(1), "", "", "", "", "", 1, DateTimeOffset.Now, DateTimeOffset.Now, false, "", new UomId(1), "", "", DateTimeOffset.Now, 1/*,""*/,1,1, false);
        ...
        public void Generate_Return_Success_Subcon_Garment()
        {
            // var department = new UnitDepartmentId(1);
            var id = Guid.NewGuid();
            var subconContract = new GarmentSubconContract(id, "SUBCON GARMENT", "", "", new SupplierId(1), "", "", "", "", "", 1, DateTimeOffset.Now, DateTimeOffset.Now, false,  "", new UomId(1), "", "", DateTimeOffset.Now, 0/*,""*/,1,1, false);
        ...
        public void Generate_Return_Success_Subcon_Garment_Without_Items()
        {
            // var department = new UnitDepartmentId(1);
            var id = Guid.NewGuid();
            var subconContract = new GarmentSubconContract(id, "SUBCON GARMENT", "", "", new SupplierId(1), "", "", "", "", "", 1, DateTimeOffset.Now, DateTimeOffset.Now, false, "", new UomId(1), "", "", DateTimeOffset.Now, 1/*,""*/,1,1, false);
