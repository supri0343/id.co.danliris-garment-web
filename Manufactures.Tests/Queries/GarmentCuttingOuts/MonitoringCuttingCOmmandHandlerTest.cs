		...
		public async Task Handle_StateUnderTest_ExpectedBehavior()
		{
            try
            {
				...
				_mockGarmentPreparingItemRepository
					...
					{
					 new GarmentPreparingItem(garmentPreparingItem,1,new Domain.GarmentPreparings.ValueObjects.ProductId(1),"productCode","productName","designColor",1,new Domain.GarmentPreparings.ValueObjects.UomId(1),"uomUnit","fabricType",1,1,guidGarmentPreparing,null,"bcno","bctype",DateTime.Now).GetReadModel()
					}.AsQueryable());
