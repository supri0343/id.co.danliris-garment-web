...
{
    public class XlsMutationExpenditureGoodQueryHandlerTest : BaseCommandUnitTest
    {
        ...
        public XlsMutationExpenditureGoodQueryHandlerTest()
        {
        ...
        private GetXlsMutationExpenditureGoodsQueryHandler CreateGetXlsMutationQueryHandler()
        {
            return new GetXlsMutationExpenditureGoodsQueryHandler(_MockStorage.Object, serviceProviderMock.Object);
        }
        ...
        public async Task Handle_StateUnderTest_ExpectedBehavior()
        {
            ...
            GetXlsMutationExpenditureGoodsQuery getXlsMutation = new GetXlsMutationExpenditureGoodsQuery(1, 25, "{}", DateTime.Now, DateTime.Now.AddDays(5), "token");
