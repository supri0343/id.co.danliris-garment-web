...
namespace Manufactures.Tests.GarmentSample.Queries.GarmentMonitoringSampleFlows
{
	public class MonitoringSampleFlowCommandHandlerTest : BaseCommandUnitTest
	{
		...
		public MonitoringSampleFlowCommandHandlerTest()
		{
		...
		private GetMonitoringSampleFlowQueryHandler CreateGetMonitoringSampleFlowQueryHandler()
		{
			return new GetMonitoringSampleFlowQueryHandler(_MockStorage.Object, serviceProviderMock.Object);
		}
		...
		public async Task Handle_StateUnderTest_ExpectedBehavior()
		{
		   ...
		   GetMonitoringSampleFlowQueryHandler unitUnderTest = CreateGetMonitoringSampleFlowQueryHandler();
			...
			GetMonitoringSampleFlowQuery getMonitoring = new GetMonitoringSampleFlowQuery(1, 25, "{}", 1, DateTime.Now, null, "token");
