...
{
	public class MonitoringSampleStockFlowCommandHandlerTest : BaseCommandUnitTest
	{
		...
		public MonitoringSampleStockFlowCommandHandlerTest()
		{
           ...
           _mockGarmentCuttingInRepository = CreateMock<IGarmentSampleCuttingInRepository>();
			...
			//List<CostCalculationGarmentDataProductionReport> costCalViewModels = new List<CostCalculationGarmentDataProductionReport> {
			//	new CostCalculationGarmentDataProductionReport
			//	{
			//		data =
			//		{
		...
		private GetGarmentMonitoringSampleStockFlowQueryHandler CreateGetMonitoringSampleFlowQueryHandler()
		{
			return new GetGarmentMonitoringSampleStockFlowQueryHandler(_MockStorage.Object, serviceProviderMock.Object);
		}
		...
		public async Task Handle_StateUnderTest_ExpectedBehavior()
		{
			...
			GetGarmentMonitoringSampleStockFlowQueryHandler unitUnderTest = CreateGetMonitoringSampleFlowQueryHandler();
			...
			GetMonitoringSampleStockFlowQuery getMonitoring = new GetMonitoringSampleStockFlowQuery(1, 25, "{}", 1, "ro", DateTime.Now.AddDays(-5), DateTime.Now, "token");
