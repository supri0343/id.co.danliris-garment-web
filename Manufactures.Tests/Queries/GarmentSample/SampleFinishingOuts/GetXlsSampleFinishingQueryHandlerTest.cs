...
{
    public class GetXlsSampleFinishingQueryHandlerTest : BaseCommandUnitTest
    {
        ...
        public GetXlsSampleFinishingQueryHandlerTest()
        {
        ...
        private GetXlsSampleFinishingQueryHandler CreateGetMonitoringFinishingQueryHandler()
        {
            return new GetXlsSampleFinishingQueryHandler(_MockStorage.Object, serviceProviderMock.Object);
        }

        [Fact]
        public async Task Handle_StateUnderTest_ExpectedBehavior()
        {
            GetXlsSampleFinishingQueryHandler unitUnderTest = CreateGetMonitoringFinishingQueryHandler();
            ...
            GetXlsSampleFinishingQuery getMonitoring = new GetXlsSampleFinishingQuery(1, 25, "{}", 1, DateTime.Now, DateTime.Now.AddDays(2),"", "token");
		...
		[Fact]
		public async Task Handle_StateUnderTest_ExpectedBookkeepingBehavior()
		{
			GetXlsSampleFinishingQueryHandler unitUnderTest = CreateGetMonitoringFinishingQueryHandler();
			CancellationToken cancellationToken = CancellationToken.None;
			Guid guidPrepare = Guid.NewGuid();
			...
			GetXlsSampleFinishingQuery getMonitoring = new GetXlsSampleFinishingQuery(1, 25, "{}", 1, DateTime.Now, DateTime.Now.AddDays(2), "bookkeeping", "token");
			_mockGarmentCuttingInItemRepository
				.Setup(s => s.Query)
				.Returns(new List<GarmentSampleCuttingInItemReadModel>
				{
