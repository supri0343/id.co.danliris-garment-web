...
using Manufactures.Application.GarmentSample.SampleRequest.Queries;
...
{
    public class XlsReceiptSampleCommandHandlerTest : BaseCommandUnitTest
    {
        ...
        public XlsReceiptSampleCommandHandlerTest()
        {
        ...
        private GetXlsReceiptSampleQueryHandler CreateGetXlsReceiptSampleQueryHandler()
        {
            return new GetXlsReceiptSampleQueryHandler(_MockStorage.Object, serviceProviderMock.Object);
        }
        [Fact]
        public async Task Handle_StateUnderTest_ExpectedBehavior()
        {
            // Arrange
            GetXlsReceiptSampleQueryHandler unitUnderTest = CreateGetXlsReceiptSampleQueryHandler();
            CancellationToken cancellationToken = CancellationToken.None;
            GetXlsReceiptSampleQuery getMonitoringReceiptSample = new GetXlsReceiptSampleQuery(1, 25, "{}", DateTime.Now, DateTime.Now.AddDays(2), "token");
