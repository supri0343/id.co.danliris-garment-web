    ...
    public class GarmentXlsSubconDLOGarmentWashQueryHandlerTest : BaseCommandUnitTest
    {
        ...
        public async Task Handle_StateUnderTest_ExpectedBehavior()
        {
            ...
            _mockgarmentSubconDeliveryLetterOutItemRepository
                    ...
                    {
                    new GarmentSubconDeliveryLetterOutItem(guidSubconDLOItem,guidSubconDLO,1,new ProductId(1),"ProductCode","ProductName","ProductRemark","DesignColor",1,new UomId(1),"UomUnit", new UomId(1),"uomOutUnit","fabricType", guidSubconSewing, "roNo", "poSerialNumber", "SubconNo", "uomSatuanUnit", 1,1,"").GetReadModel()
                    }.AsQueryable());
