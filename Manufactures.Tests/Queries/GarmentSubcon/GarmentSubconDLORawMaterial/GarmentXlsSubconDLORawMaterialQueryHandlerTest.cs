    ...
    public class GarmentXlsSubconDLORawMaterialQueryHandlerTest : BaseCommandUnitTest
    {
        ...
        public async Task Handle_StateUnderTest_ExpectedBehavior()
        {
            ...
            _mockgarmentSubconDeliveryLetterOutItemRepository
                ...
                {   
                    new GarmentSubconDeliveryLetterOutItem(guidSubconDLOItem, guidSubconDLO, 1, new ProductId(1), "productCode", "productName", "productRemark", "designColor", 2, new UomId(1), "uomUnit", new UomId(1), "uomOutUnit", "fabricType", guidSubconShrinkagePanel, "roNo", "poSerialNumber", "subconNo", "uomSatuanUnit", 1,1,"").GetReadModel(),
                    new GarmentSubconDeliveryLetterOutItem(guidSubconDLOItem, guidSubconDLO2, 1, new ProductId(1), "productCode", "productName", "productRemark", "designColor", 2, new UomId(1), "uomUnit", new UomId(1), "uomOutUnit", "fabricType", guidSubconShrinkagePanel, "roNo", "poSerialNumber", "subconNo", "uomSatuanUnit", 1,1,"").GetReadModel()
