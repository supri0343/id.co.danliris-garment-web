    ...
    public class GarmentXlsSubconDLOGarmentWashQueryHandlerTest : BaseCommandUnitTest
    {
        ...
        public async Task Handle_StateUnderTest_ExpectedBehavior()
        {
            ...
            _mockgarmentSubconDeliveryLetterOutRepository
                ...
                {
                        new GarmentSubconDeliveryLetterOut(guidSubconDLO, "dLNo", "dLType", Guid.Empty, "contractNo", "SUBCON GARMENT", DateTimeOffset.Now, 1, "uENNo", "pONo", 1, "remark", true, "serviceType", "SUBCON SEWING" ,"JOB ORDER").GetReadModel()
            ...
            _mockgarmentSubconDeliveryLetterOutItemRepository
                ...
                {
                    new GarmentSubconDeliveryLetterOutItem(guidSubonDLOItem, guidSubconDLO, 1, new ProductId(1), "productCode", "productName", "productRemark", "designColor", 1, new UomId(1), "uomUnit", new UomId(1), "uomOutUnit", "fabricType", guidCuttingOut, "roNo", "poSerialNumber", "subconNo", "uomSatuanUnit", 1,1,"",1,"").GetReadModel()
                }.AsQueryable());
