    ...
    public class GarmentXlsSubconCuttingQueryHandlerTest : BaseCommandUnitTest
    {
        ...
        public async Task Handle_StateUnderTest_ExpectedBehavior()
        {
            ...
            _mockgarmentSubconCuttingRepository
                ...
                {
                        new GarmentServiceSubconCutting(guidSubconCutting, "SJCB001", "SCCuttingType", new UnitDepartmentId (1), "UnitCode", "UnitName", DateTimeOffset.Now, false, new BuyerId (1), "BuyerCode", "BuyerName").GetReadModel()
