...
{
    public class PlaceGarmentCuttingInCommandValidatorTest
    {
        private PlaceGarmentCuttingInCommandValidator GetValidationRules()
        {
            return new PlaceGarmentCuttingInCommandValidator();
        }
        ...
        public void Place_HaveError()
        {
            ...
            var unitUnderTest = new PlaceGarmentCuttingInCommand();
