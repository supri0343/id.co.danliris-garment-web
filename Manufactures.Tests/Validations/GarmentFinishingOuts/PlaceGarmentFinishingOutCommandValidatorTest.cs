...
{
    public class PlaceGarmentFinishingOutCommandValidatorTest
    {
        private PlaceGarmentFinishingOutCommandValidator GetValidationRules()
        {
            return new PlaceGarmentFinishingOutCommandValidator();
        }
