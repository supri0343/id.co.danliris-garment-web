...
{
    public class UpdateGarmentSampleRequestCommandHandlerValidationTest
    {
        private UpdateGarmentSampleRequestCommandValidator GetValidationRules()
        {
            return new UpdateGarmentSampleRequestCommandValidator();
        }
        ...
        public void Update_ShouldHaveError()
        {
            ...
            var unitUnderTest = new UpdateGarmentSampleRequestCommand();
