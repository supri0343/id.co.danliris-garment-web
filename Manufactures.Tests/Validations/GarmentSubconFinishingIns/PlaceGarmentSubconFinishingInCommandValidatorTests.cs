    ...
    public class PlaceGarmentSubconFinishingInCommandValidatorTests : BaseValidatorUnitTest
    {
        ...
        public void Place_HaveError()
        {
            ...
            _mockGarmentFinishingInRepository.Setup(s => s.Query)
                ...
                {
                    new GarmentFinishingIn(Guid.Empty, null, null, new UnitDepartmentId(1), null, null, "RONo", null, new UnitDepartmentId(1), null, null, DateTimeOffset.Now, new GarmentComodityId(1), null, null, 1, "DONo").GetReadModel()
                }.AsQueryable());
        ...
        public void Place_NotHaveError()
        {
            ...
            _mockGarmentFinishingInRepository.Setup(s => s.Query)
                .Returns(new List<GarmentFinishingInReadModel>
                {
                    new GarmentFinishingIn(Guid.Empty, null, null, new UnitDepartmentId(1), null, null, "NotRONo", null, new UnitDepartmentId(1), null, null, DateTimeOffset.Now, new GarmentComodityId(1), null, null, 1, "NotDONo").GetReadModel()
                }.AsQueryable());
