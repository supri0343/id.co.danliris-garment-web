...
namespace Manufactures.Tests.ViewModels.GarmentAvalProducts
{
    public class CreateViewModelMapperTest
    {
        ...
        {
            Guid id = Guid.NewGuid();
            GarmentAvalProductItemDto dto = new GarmentAvalProductItemDto(new GarmentAvalProductItem(id, id, new GarmentPreparingId("value"), new GarmentPreparingItemId("value"), new ProductId(1), "productCode", "productName", "designColor", 1, new UomId(1), "uomUnit", 1, true,"BCNo",DateTime.Now,"PoSerial",""));
            CreateViewModelMapper viewModelMapper = new CreateViewModelMapper();
