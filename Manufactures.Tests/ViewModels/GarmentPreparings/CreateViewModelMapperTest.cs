    ...
    public class CreateViewModelMapperTest
    {
        ...
        public void Map_Return_Success()
        {
            ...
            CreateViewModel viewModel = new CreateViewModel()
            {
                ...
                {
                    new GarmentPreparingItemValueObject(id,1,new Product(),"designColor",1,new Uom(1,"uomUnit"),"fabricType",1,1,id,null,"bcno","bctype",DateTime.Now)
                }
            };
        ...
        {
            Guid id = Guid.NewGuid();
            GarmentPreparingItemDto dto = new GarmentPreparingItemDto(new GarmentPreparingItem(id,1,new ProductId(1),"productCode","productName","designColor",1,new UomId(1),"uomUnit","fabricType",1,1,id,null, "bcno", "bctype", DateTime.Now));
            CreateViewModelMapper viewModelMapper = new CreateViewModelMapper();
