...
{
    public class GarmentExpenditureGoodForOmzetDto
    {
        public GarmentExpenditureGoodForOmzetDto()
        {
        }
        ...
        public GarmentExpenditureGoodForOmzetDto(GarmentExpenditureGoodForOmzetDto getReportExpenditure)
        {
