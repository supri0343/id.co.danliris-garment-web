		...
		public async Task<MemoryStream> Handle(GetXlsMonitoringProductionStockFlowQuery request, CancellationToken cancellationToken)
		{
			...
			foreach (var item in querySum)
			{
				GarmentMonitoringProductionStockFlowDto garmentMonitoringDto = new GarmentMonitoringProductionStockFlowDto()
				{
					...
					PriceCuttingTransfer = ((Convert.ToDouble(item.fare) * 0.25) + (Convert.ToDouble(item.basicprice) * item.fc)) * item.qtyCuttingTransfer,
					QtyCuttingsubkon = item.qtCuttingSubkon,
					PriceCuttingsubkon = ((Convert.ToDouble(item.fare) * 0.25) + (Convert.ToDouble(item.basicprice) * item.fc)) * item.qtCuttingSubkon,
					QtyCuttingIn = item.qtyCuttingIn,
					PriceCuttingIn = ((Convert.ToDouble(item.fare) * 0.25) + (Convert.ToDouble(item.basicprice) * item.fc)) * item.qtyCuttingIn,
					QtyCuttingOut = item.qtycutting,
					PriceCuttingOut = ((Convert.ToDouble(item.fare) * 0.25) + (Convert.ToDouble(item.basicprice) * item.fc)) * item.qtycutting,
					Comodity = item.comodity,
					AvalCutting = item.qtyavalcut,
					AvalCuttingPrice = ((Convert.ToDouble(item.fare) * 0.25) + (Convert.ToDouble(item.basicprice) * item.fc)) * item.qtyavalcut,
					AvalSewing = item.qtyavalsew,
					AvalSewingPrice = ((Convert.ToDouble(item.fare) * 0.25) + (Convert.ToDouble(item.basicprice) * item.fc)) * item.qtyavalsew,
					...
					BeginingBalanceLoadingPrice = ((Convert.ToDouble(item.fare) * 0.25) + (Convert.ToDouble(item.basicprice) * item.fc)) * item.beginingloading,
					QtyLoadingIn = item.qtyLoadingIn,
					PriceLoadingIn = ((Convert.ToDouble(item.fare) * 0.25) + (Convert.ToDouble(item.basicprice) * item.fc)) * item.qtyLoadingIn,
					QtyLoadingInTransfer = item.qtyloadingInTransfer,
					PriceLoadingInTransfer = ((Convert.ToDouble(item.fare) * 0.25) + (Convert.ToDouble(item.basicprice) * item.fc)) * item.qtyloadingInTransfer,
					QtyLoading = item.qtyloading,
					PriceLoading = ((Convert.ToDouble(item.fare) * 0.25) + (Convert.ToDouble(item.basicprice) * item.fc)) * item.qtyloading,
					QtyLoadingAdjs = item.qtyLoadingAdj,
					PriceLoadingAdjs = ((Convert.ToDouble(item.fare) * 0.25) + (Convert.ToDouble(item.basicprice) * item.fc)) * item.qtyLoadingAdj,
					...
					BeginingBalanceSewingPrice = ((Convert.ToDouble(item.fare) * 0.5) + (Convert.ToDouble(item.basicprice) * item.fc)) * item.beginingSewing,
					QtySewingIn = item.sewingIn,
					PriceSewingIn = ((Convert.ToDouble(item.fare) * 0.5) + (Convert.ToDouble(item.basicprice) * item.fc)) * item.sewingIn,
					QtySewingOut = item.sewingout,
					PriceSewingOut = ((Convert.ToDouble(item.fare) * 0.5) + (Convert.ToDouble(item.basicprice) * item.fc)) * item.sewingout,
					QtySewingInTransfer = item.sewingintransfer,
					PriceSewingInTransfer = ((Convert.ToDouble(item.fare) * 0.5) + (Convert.ToDouble(item.basicprice) * item.fc)) * item.sewingintransfer,
					QtySewingRetur = item.sewingretur,
					PriceSewingRetur = ((Convert.ToDouble(item.fare) * 0.5) + (Convert.ToDouble(item.basicprice) * item.fc)) * item.sewingretur,
					WipSewingOut = item.wipsewing,
					WipSewingOutPrice = ((Convert.ToDouble(item.fare) * 0.5) + (Convert.ToDouble(item.basicprice) * item.fc)) * item.wipsewing,
					WipFinishingOut = item.wipfinishing,
					WipFinishingOutPrice = ((Convert.ToDouble(item.fare) * 0.5) + (Convert.ToDouble(item.basicprice) * item.fc)) * item.wipfinishing,
					QtySewingAdj = item.sewingadj,
					PriceSewingAdj = ((Convert.ToDouble(item.fare) * 0.5) + (Convert.ToDouble(item.basicprice) * item.fc)) * item.sewingadj,
					...
					EndBalanceSewingPrice = ((Convert.ToDouble(item.fare) * 0.5) + (Convert.ToDouble(item.basicprice) * item.fc)) * item.beginingSewing + item.sewingIn - item.sewingout + item.sewingintransfer - item.wipsewing - item.wipfinishing - item.sewingretur - item.sewingadj,
					BeginingBalanceFinishingQty = item.beginingbalanceFinishing,
					BeginingBalanceFinishingPrice = ((Convert.ToDouble(item.fare) * 0.75) + (Convert.ToDouble(item.basicprice) * item.fc)) * item.beginingbalanceFinishing,
					FinishingInExpenditure = item.finishingout + item.subconout,
					FinishingInExpenditurepPrice = (((Convert.ToDouble(item.fare) * 0.75) + (Convert.ToDouble(item.basicprice) * item.fc)) * item.finishingout) + (((Convert.ToDouble(item.fare) * 0.75) + (Convert.ToDouble(item.basicprice) * item.fc)) * item.subconout),
					FinishingInQty = item.finishingin,
					FinishingInPrice = ((Convert.ToDouble(item.fare) * 0.75) + (Convert.ToDouble(item.basicprice) * item.fc)) * item.finishingin,
					FinishingOutQty = item.finishingout,
					FinishingOutPrice = ((Convert.ToDouble(item.fare) * 0.75) + (Convert.ToDouble(item.basicprice) * item.fc)) * item.finishingout,
					BeginingBalanceSubconQty = item.beginingbalancesubcon,
					BeginingBalanceSubconPrice = ((Convert.ToDouble(item.fare) * 0.75) + (Convert.ToDouble(item.basicprice) * item.fc)) * item.beginingbalancesubcon,
					SubconInQty = item.subconIn,
					SubconInPrice = ((Convert.ToDouble(item.fare) * 0.75) + (Convert.ToDouble(item.basicprice) * item.fc)) * item.subconIn,
					SubconOutQty = item.subconout,
					SubconOutPrice = ((Convert.ToDouble(item.fare) * 0.75) + (Convert.ToDouble(item.basicprice) * item.fc)) * item.subconout,
					EndBalanceSubconQty = item.beginingbalancesubcon + item.subconIn - item.subconout,
					EndBalanceSubconPrice = ((Convert.ToDouble(item.fare) * 0.75) + (Convert.ToDouble(item.basicprice) * item.fc)) * (item.beginingbalancesubcon + item.subconIn - item.subconout),
					FinishingInTransferQty = item.finishingintransfer,
					FinishingInTransferPrice = ((Convert.ToDouble(item.fare) * 0.75) + (Convert.ToDouble(item.basicprice) * item.fc)) * item.finishingintransfer,
					FinishingReturQty = item.finishinigretur,
					FinishingReturPrice = ((Convert.ToDouble(item.fare) * 0.75) + (Convert.ToDouble(item.basicprice) * item.fc)) * item.finishinigretur,
					FinishingAdjQty = item.finishingadj,
					FinishingAdjPRice = ((Convert.ToDouble(item.fare) * 0.75) + (Convert.ToDouble(item.basicprice) * item.fc)) * item.finishingadj,
					BeginingBalanceExpenditureGood = item.beginingBalanceExpenditureGood,
					BeginingBalanceExpenditureGoodPrice = ((Convert.ToDouble(item.fare)) + (Convert.ToDouble(item.basicprice) * item.fc)) * item.beginingBalanceExpenditureGood,
					...
					EndBalanceFinishingPrice = ((Convert.ToDouble(item.fare) * 0.75) + (Convert.ToDouble(item.basicprice) * item.fc)) * (item.beginingbalanceFinishing + item.finishingin + item.finishingintransfer - item.finishingout - item.finishingadj - item.finishinigretur),
					ExportQty = item.exportQty,
					ExportPrice = ((Convert.ToDouble(item.fare)) + (Convert.ToDouble(item.basicprice) * item.fc)) * item.exportQty,
					SampleQty = item.sampleQty,
					SamplePrice = ((Convert.ToDouble(item.fare)) + (Convert.ToDouble(item.basicprice) * item.fc)) * item.sampleQty,
					OtherQty = item.otherqty,
					OtherPrice = ((Convert.ToDouble(item.fare)) + (Convert.ToDouble(item.basicprice) * item.fc)) * item.otherqty,
					ExpenditureGoodAdj = item.expendAdj,
					ExpenditureGoodAdjPrice = ((Convert.ToDouble(item.fare)) + (Convert.ToDouble(item.basicprice) * item.fc)) * item.expendAdj,
					ExpenditureGoodRetur = item.expendRetur,
					ExpenditureGoodReturPrice = ((Convert.ToDouble(item.fare)) + (Convert.ToDouble(item.basicprice) * item.fc)) * item.expendRetur,
					ExpenditureGoodInTransfer = item.expenditureInTransfer,
					ExpenditureGoodInTransferPrice = ((Convert.ToDouble(item.fare)) + (Convert.ToDouble(item.basicprice) * item.fc)) * item.expenditureInTransfer,
					...
					EndBalanceExpenditureGoodPrice = ((Convert.ToDouble(item.fare)) + (Convert.ToDouble(item.basicprice) * item.fc)) * (item.beginingBalanceExpenditureGood + item.finishingout + item.subconout + item.expendRetur + item.expenditureInTransfer - item.exportQty - item.otherqty - item.sampleQty - item.expendAdj),
