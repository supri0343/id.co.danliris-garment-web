		...
		public async Task<MemoryStream> Handle(GetXlsMonitoringProductionStockFlowQuery request, CancellationToken cancellationToken)
		{
			...
			foreach (var item in querySum)
			{
				GarmentMonitoringProductionStockFlowDto garmentMonitoringDto = new GarmentMonitoringProductionStockFlowDto()
				{
					...
					BeginingBalanceCuttingPrice = ((Convert.ToDouble(item.fare) * 0.25) + (Math.Round(Convert.ToDouble(item.basicprice) * item.fc, 2))) * item.begining,
					QtyCuttingTransfer = item.qtyCuttingTransfer,
					PriceCuttingTransfer = ((Convert.ToDouble(item.fare) * 0.25) + (Math.Round(Convert.ToDouble(item.basicprice) * item.fc,2))) * item.qtyCuttingTransfer,
					QtyCuttingsubkon = item.qtCuttingSubkon,
					PriceCuttingsubkon = ((Convert.ToDouble(item.fare) * 0.25) + (Math.Round(Convert.ToDouble(item.basicprice) * item.fc,2))) * item.qtCuttingSubkon,
					QtyCuttingIn = item.qtyCuttingIn,
					PriceCuttingIn = ((Convert.ToDouble(item.fare) * 0.25) + (Math.Round(Convert.ToDouble(item.basicprice) * item.fc,2))) * item.qtyCuttingIn,
					QtyCuttingOut = item.qtycutting,
					PriceCuttingOut = ((Convert.ToDouble(item.fare) * 0.25) + (Math.Round(Convert.ToDouble(item.basicprice) * item.fc,2))) * item.qtycutting,
					Comodity = item.comodity,
					AvalCutting = item.qtyavalcut,
					AvalCuttingPrice = ((Convert.ToDouble(item.fare) * 0.25) + (Math.Round(Convert.ToDouble(item.basicprice) * item.fc,2))) * item.qtyavalcut,
					AvalSewing = item.qtyavalsew,
					AvalSewingPrice = ((Convert.ToDouble(item.fare) * 0.25) + (Math.Round(Convert.ToDouble(item.basicprice) * item.fc,2))) * item.qtyavalsew,
					...
					EndBalancCuttingePrice = ((Convert.ToDouble(item.fare) * 0.25) + (Math.Round(Convert.ToDouble(item.basicprice) * item.fc,2))) * (item.beginingcuttingPrice + item.priceCuttingIn - item.priceCuttingOut - item.priceCuttingTransfer - item.priceCuttingSubkon - item.priceavalcut - item.priceavalsew),
					BeginingBalanceLoadingQty = item.beginingloading,
					BeginingBalanceLoadingPrice = ((Convert.ToDouble(item.fare) * 0.25) + (Math.Round(Convert.ToDouble(item.basicprice) * item.fc,2))) * item.beginingloading,
					QtyLoadingIn = item.qtyLoadingIn,
					PriceLoadingIn = ((Convert.ToDouble(item.fare) * 0.25) + (Math.Round(Convert.ToDouble(item.basicprice) * item.fc,2))) * item.qtyLoadingIn,
					QtyLoadingInTransfer = item.qtyloadingInTransfer,
					PriceLoadingInTransfer = ((Convert.ToDouble(item.fare) * 0.25) + (Math.Round(Convert.ToDouble(item.basicprice) * item.fc,2))) * item.qtyloadingInTransfer,
					QtyLoading = item.qtyloading,
					PriceLoading = ((Convert.ToDouble(item.fare) * 0.25) + (Math.Round(Convert.ToDouble(item.basicprice) * item.fc,2))) * item.qtyloading,
					QtyLoadingAdjs = item.qtyLoadingAdj,
					PriceLoadingAdjs = ((Convert.ToDouble(item.fare) * 0.25) + (Math.Round(Convert.ToDouble(item.basicprice) * item.fc,2))) * item.qtyLoadingAdj,
					EndBalanceLoadingQty = item.beginingloading + item.qtyLoadingIn + item.qtyloadingInTransfer - item.qtyloading - item.qtyLoadingAdj,
					EndBalanceLoadingPrice = ((Convert.ToDouble(item.fare) * 0.25) + (Math.Round(Convert.ToDouble(item.basicprice) * item.fc,2))) * (item.beginingloadingPrice + item.priceLoadingIn + item.qtyloadingInTransfer - item.priceloading - item.priceLoadingAdj),
					BeginingBalanceSewingQty = item.beginingSewing,
					BeginingBalanceSewingPrice = ((Convert.ToDouble(item.fare) * 0.5) + (Math.Round(Convert.ToDouble(item.basicprice) * item.fc,2))) * item.beginingSewing,
					QtySewingIn = item.sewingIn,
					PriceSewingIn = ((Convert.ToDouble(item.fare) * 0.5) + (Math.Round(Convert.ToDouble(item.basicprice) * item.fc,2))) * item.sewingIn,
					QtySewingOut = item.sewingout,
					PriceSewingOut = ((Convert.ToDouble(item.fare) * 0.5) + (Math.Round(Convert.ToDouble(item.basicprice) * item.fc,2))) * item.sewingout,
					QtySewingInTransfer = item.sewingintransfer,
					PriceSewingInTransfer = ((Convert.ToDouble(item.fare) * 0.5) + (Math.Round(Convert.ToDouble(item.basicprice) * item.fc,2))) * item.sewingintransfer,
					QtySewingRetur = item.sewingretur,
					PriceSewingRetur = ((Convert.ToDouble(item.fare) * 0.5) + (Math.Round(Convert.ToDouble(item.basicprice) * item.fc,2))) * item.sewingretur,
					WipSewingOut = item.wipsewing,
					WipSewingOutPrice = ((Convert.ToDouble(item.fare) * 0.5) + (Math.Round(Convert.ToDouble(item.basicprice) * item.fc,2))) * item.wipsewing,
					WipFinishingOut = item.wipfinishing,
					WipFinishingOutPrice = ((Convert.ToDouble(item.fare) * 0.5) + (Math.Round(Convert.ToDouble(item.basicprice) * item.fc,2))) * item.wipfinishing,
					QtySewingAdj = item.sewingadj,
					PriceSewingAdj = ((Convert.ToDouble(item.fare) * 0.5) + (Math.Round(Convert.ToDouble(item.basicprice) * item.fc,2))) * item.sewingadj,
					...
					EndBalanceSewingPrice = ((Convert.ToDouble(item.fare) * 0.5) + (Math.Round(Convert.ToDouble(item.basicprice) * item.fc,2))) * item.beginingSewing + item.sewingIn - item.sewingout + item.sewingintransfer - item.wipsewing - item.wipfinishing - item.sewingretur - item.sewingadj,
					BeginingBalanceFinishingQty = item.beginingbalanceFinishing,
					BeginingBalanceFinishingPrice = ((Convert.ToDouble(item.fare) * 0.75) + (Math.Round(Convert.ToDouble(item.basicprice) * item.fc,2))) * item.beginingbalanceFinishing,
					FinishingInExpenditure = item.finishingout + item.subconout,
					FinishingInExpenditurepPrice = (((Convert.ToDouble(item.fare) * 0.75) + (Math.Round(Convert.ToDouble(item.basicprice) * item.fc,2))) * item.finishingout) + (((Convert.ToDouble(item.fare) * 0.75) + (Math.Round(Convert.ToDouble(item.basicprice) * item.fc,2))) * item.subconout),
					FinishingInQty = item.finishingin,
					FinishingInPrice = ((Convert.ToDouble(item.fare) * 0.75) + (Math.Round(Convert.ToDouble(item.basicprice) * item.fc,2))) * item.finishingin,
					FinishingOutQty = item.finishingout,
					FinishingOutPrice = ((Convert.ToDouble(item.fare) * 0.75) + (Math.Round(Convert.ToDouble(item.basicprice) * item.fc,2))) * item.finishingout,
					BeginingBalanceSubconQty = item.beginingbalancesubcon,
					BeginingBalanceSubconPrice = ((Convert.ToDouble(item.fare) * 0.75) + (Math.Round(Convert.ToDouble(item.basicprice) * item.fc,2))) * item.beginingbalancesubcon,
					SubconInQty = item.subconIn,
					SubconInPrice = ((Convert.ToDouble(item.fare) * 0.75) + (Math.Round(Convert.ToDouble(item.basicprice) * item.fc,2))) * item.subconIn,
					SubconOutQty = item.subconout,
					SubconOutPrice = ((Convert.ToDouble(item.fare) * 0.75) + (Math.Round(Convert.ToDouble(item.basicprice) * item.fc,2))) * item.subconout,
					EndBalanceSubconQty = item.beginingbalancesubcon + item.subconIn - item.subconout,
					EndBalanceSubconPrice = ((Convert.ToDouble(item.fare) * 0.75) + (Math.Round(Convert.ToDouble(item.basicprice) * item.fc,2))) * (item.beginingbalancesubcon + item.subconIn - item.subconout),
					FinishingInTransferQty = item.finishingintransfer,
					FinishingInTransferPrice = ((Convert.ToDouble(item.fare) * 0.75) + (Math.Round(Convert.ToDouble(item.basicprice) * item.fc,2))) * item.finishingintransfer,
					FinishingReturQty = item.finishinigretur,
					FinishingReturPrice = ((Convert.ToDouble(item.fare) * 0.75) + (Math.Round(Convert.ToDouble(item.basicprice) * item.fc,2))) * item.finishinigretur,
					FinishingAdjQty = item.finishingadj,
					FinishingAdjPRice = ((Convert.ToDouble(item.fare) * 0.75) + (Math.Round(Convert.ToDouble(item.basicprice) * item.fc,2))) * item.finishingadj,
					BeginingBalanceExpenditureGood = item.beginingBalanceExpenditureGood,
					BeginingBalanceExpenditureGoodPrice = ((Convert.ToDouble(item.fare)) + (Math.Round(Convert.ToDouble(item.basicprice) * item.fc,2))) * item.beginingBalanceExpenditureGood,
					...
					EndBalanceFinishingPrice = ((Convert.ToDouble(item.fare) * 0.75) + (Math.Round(Convert.ToDouble(item.basicprice) * item.fc,2))) * (item.beginingbalanceFinishing + item.finishingin + item.finishingintransfer - item.finishingout - item.finishingadj - item.finishinigretur),
					ExportQty = item.exportQty,
					ExportPrice = ((Convert.ToDouble(item.fare)) + (Math.Round(Convert.ToDouble(item.basicprice) * item.fc,2))) * item.exportQty,
					SampleQty = item.sampleQty,
					SamplePrice = ((Convert.ToDouble(item.fare)) + (Math.Round(Convert.ToDouble(item.basicprice) * item.fc,2))) * item.sampleQty,
					OtherQty = item.otherqty,
					OtherPrice = ((Convert.ToDouble(item.fare)) + (Math.Round(Convert.ToDouble(item.basicprice) * item.fc,2))) * item.otherqty,
					ExpenditureGoodAdj = item.expendAdj,
					ExpenditureGoodAdjPrice = ((Convert.ToDouble(item.fare)) + (Math.Round(Convert.ToDouble(item.basicprice) * item.fc,2))) * item.expendAdj,
					ExpenditureGoodRetur = item.expendRetur,
					ExpenditureGoodReturPrice = ((Convert.ToDouble(item.fare)) + (Math.Round(Convert.ToDouble(item.basicprice) * item.fc,2))) * item.expendRetur,
					ExpenditureGoodInTransfer = item.expenditureInTransfer,
					ExpenditureGoodInTransferPrice = ((Convert.ToDouble(item.fare)) + (Math.Round(Convert.ToDouble(item.basicprice) * item.fc,2))) * item.expenditureInTransfer,
					...
					EndBalanceExpenditureGoodPrice = ((Convert.ToDouble(item.fare)) + (Math.Round(Convert.ToDouble(item.basicprice) * item.fc,2))) * (item.beginingBalanceExpenditureGood + item.finishingout + item.subconout + item.expendRetur + item.expenditureInTransfer - item.exportQty - item.otherqty - item.sampleQty - item.expendAdj),
					...
					SubconNew = item.farenew * Convert.ToDecimal(item.beginingbalancesubcon + item.subconIn - item.subconout)
				};
			...
			foreach (var report in garmentMonitoringProductionFlow.garmentMonitorings)
			{
				...
				else
				{
					reportDataTable.Rows.Add(report.Ro, report.Article, report.BuyerCode, report.Comodity, report.QtyOrder, report.FC, report.Hours, report.Fare, report.BasicPrice,
						...
						report.BeginingBalanceExpenditureGood, Math.Round(report.BeginingBalanceExpenditureGoodPrice,2), report.ExpenditureGoodInTransfer, Math.Round(report.ExpenditureGoodInTransferPrice,2), report.FinishingInTransferQty, Math.Round(report.FinishingInTransferPrice,2), report.ExpenditureGoodRetur, Math.Round(report.ExpenditureGoodReturPrice,2),report.FinishingInExpenditure * Convert.ToDouble(report.Fare), report.FinishingInExpenditure * report.BasicPrice, report.ExportQty, Math.Round(report.ExportPrice,2), report.OtherQty, Math.Round(report.OtherPrice,2), report.SampleQty, Math.Round(report.SamplePrice,2), report.ExpenditureGoodAdj, Math.Round(report.ExpenditureGoodAdjPrice,2), report.EndBalanceExpenditureGood, Math.Round(report.EndBalanceExpenditureGoodPrice,2),
