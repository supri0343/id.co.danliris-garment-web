...
namespace Manufactures.Application.GarmentSample.GarmentMonitoringSampleStockFlows.Queries
{
	public class GetXlsMonitoringSampleStockFlowQueryHandler : IQueryHandler<GetXlsMonitoringSampleStockFlowQuery, MemoryStream>
	{
		...
		public async Task<MemoryStream> Handle(GetXlsMonitoringSampleStockFlowQuery request, CancellationToken cancellationToken)
		{
            ...
            //    GarmentMonitoringSampleStockFlowDto garmentMonitoringDto = new GarmentMonitoringSampleStockFlowDto()
            //    {
            ...
            //var roBalance = from a in garmentBalanceSampleStockRepository.Query
            //                select new CostCalViewModel { comodityName = a.Comodity, buyerCode = a.BuyerCode, hours = a.Hours, qtyOrder = a.QtyOrder, ro = a.Ro };

            //CostCalculationGarmentDataSampleReport costCalculation = await GetDataCostCal(roList, request.token);
