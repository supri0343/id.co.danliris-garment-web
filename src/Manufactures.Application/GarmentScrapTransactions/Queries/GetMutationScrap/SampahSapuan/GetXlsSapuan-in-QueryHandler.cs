...
{
    public class GetXlsSapuan_in_QueryHandler : IQueryHandler<GetXlsSapuan_in_Query, MemoryStream>
    {
        ...
        public GetXlsSapuan_in_QueryHandler(IStorage storage)
        {
            _storage = storage;
        ...
        public async Task<MemoryStream> Handle(GetXlsSapuan_in_Query request, CancellationToken cancellationToken)
        {
            ...
            var sapuan = (from a in _garmentScrapTransactionRepository.Query
                                ...
                                && a.TransactionType == "IN" && b.ScrapClassificationName == "SAMPAH SAPUAN"
            ...
            using (var package = new ExcelPackage())
            {
                ...
                worksheet.Cells["A1"].Value = "Laporan Monitoring Pemasukan Aval Sampah Sapuan";
