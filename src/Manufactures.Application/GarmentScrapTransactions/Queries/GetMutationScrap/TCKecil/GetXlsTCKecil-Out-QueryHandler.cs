...
{
    public class GetXlsTCKecil_Out_QueryHandler : IQueryHandler<GetXlsTCKecil_Out_Query, MemoryStream>
    {
        ...
        public GetXlsTCKecil_Out_QueryHandler(IStorage storage)
        {
            _storage = storage;
        ...
        public async Task<MemoryStream> Handle(GetXlsTCKecil_Out_Query request, CancellationToken cancellationToken)
        {
            ...
            var ScrapTCKecil = (from a in _garmentScrapTransactionRepository.Query
                                ...
                                && a.TransactionType == "OUT" && b.ScrapClassificationName == "AVAL TC KECIL"
            ...
            using (var package = new ExcelPackage())
            {
                ...
                worksheet.Cells["A1"].Value = "Laporan Monitoring Pengeluaran Aval TC Kecil";
