    ...
    public class RemoveGarmentSewingOutCommandHandler : ICommandHandler<RemoveGarmentSewingOutCommand, GarmentSewingOut>
    {
        ...
        public async Task<GarmentSewingOut> Handle(RemoveGarmentSewingOutCommand request, CancellationToken cancellationToken)
        {
            ...
            if (sewOut.SewingTo == "CUTTING")
            {
                ...
                //Add Log History
                LogHistory logHistory1 = new LogHistory(new Guid(), "PRODUKSI CUTTING", "Delete Cutting In - " + cutIn.CutInNo, DateTime.Now);
            ...
            if (sewOut.SewingTo == "SEWING")
            {
                ...
                //Add Log History
                LogHistory logHistory1 = new LogHistory(new Guid(), "PRODUKSI SEWING", "Delete Sewing In - " + sewIn.SewingInNo, DateTime.Now);
                await _logHistoryRepository.Update(logHistory1);
            }
            ...
            if (sewOut.SewingTo == "FINISHING")
            {
                ...
                //Add Log History
                LogHistory logHistory1 = new LogHistory(new Guid(), "PRODUKSI FINISHING", "Delete Finishing In - " + finIn.FinishingInNo, DateTime.Now);
                await _logHistoryRepository.Update(logHistory1);
            }
            ...
            //Add Log History
            LogHistory logHistory = new LogHistory(new Guid(), "PRODUKSI SEWING", "Delete Sewing Out - " + sewOut.SewingOutNo, DateTime.Now);
