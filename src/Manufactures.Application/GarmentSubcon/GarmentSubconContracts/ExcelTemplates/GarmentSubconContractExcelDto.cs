...
{
    public class GarmentSubconContractExcelDto
    {
        public GarmentSubconContractExcelDto(GarmentSubconContract garmentSubconContract)
        {
            ...
            Items = new List<GarmentSubconContractItemExcelDto>();
        }
        ...
        public List<GarmentSubconContractItemExcelDto> Items { get; set; }
    }
}
