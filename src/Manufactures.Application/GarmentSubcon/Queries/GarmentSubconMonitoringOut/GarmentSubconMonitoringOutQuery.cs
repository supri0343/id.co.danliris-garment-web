...
{
    public class GarmentSubconMonitoringOutQuery : IQuery<GarmentSubconMonitoringOutViewModel>
    {
        ...
        public GarmentSubconMonitoringOutQuery(int page, int size, string order, string subconcontractNo, string subconContractType, string subconCategory,  string token)
        {
            this.page = page;
            this.size = size;
            this.order = order;
