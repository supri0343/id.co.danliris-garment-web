...
{
    public class GarmentServiceSampleShrinkagePanelDetailRepository : AggregateRepostory<GarmentServiceSampleShrinkagePanelDetail, GarmentServiceSampleShrinkagePanelDetailReadModel>, IGarmentServiceSampleShrinkagePanelDetailRepository
    {
