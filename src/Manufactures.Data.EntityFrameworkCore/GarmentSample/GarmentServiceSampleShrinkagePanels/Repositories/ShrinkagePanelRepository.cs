...
{
    public class ShrinkagePanelRepository : AggregateRepostory<GarmentServiceSampleShrinkagePanel, GarmentServiceSampleShrinkagePanelReadModel>, IGarmentServiceSampleShrinkagePanelRepository
    {
