...
{
    public class GarmentSampleFinishingOutConfig : IEntityTypeConfiguration<GarmentSampleFinishingOutReadModel>
    {
        public void Configure(EntityTypeBuilder<GarmentSampleFinishingOutReadModel> builder)
        {
            builder.ToTable("GarmentSampleFinishingOuts");
