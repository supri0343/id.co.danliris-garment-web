...
{
    public class UpdateGarmentSampleCuttingOutCommand : ICommand<GarmentSampleCuttingOut>
    {
        ...
        public class UpdateGarmentSampleCuttingOutCommandValidator : AbstractValidator<UpdateGarmentSampleCuttingOutCommand>
        {
            public UpdateGarmentSampleCuttingOutCommandValidator()
            {
