...
{
    public class PlaceGarmentSampleSewingOutCommand : ICommand<GarmentSampleSewingOut>
    {
        ...
        public List<GarmentSampleSewingOutItemValueObject> Items { get; set; }
    ...
    public class PlaceGarmentSampleSewingOutCommandValidator : AbstractValidator<PlaceGarmentSampleSewingOutCommand>
    {
        public PlaceGarmentSampleSewingOutCommandValidator()
        {
            ...
            RuleForEach(r => r.Items).SetValidator(new GarmentSampleSewingOutItemValueObjectValidator());
        }
    }
    ...
    public class GarmentSampleSewingOutItemValueObjectValidator : AbstractValidator<GarmentSampleSewingOutItemValueObject>
    {
        public GarmentSampleSewingOutItemValueObjectValidator()
        {
            ...
            RuleForEach(r => r.Details).SetValidator(new GarmentSampleSewingOutDetailValueObjectValidator()).When(r => r.IsDifferentSize == true && r.IsSave == true);
