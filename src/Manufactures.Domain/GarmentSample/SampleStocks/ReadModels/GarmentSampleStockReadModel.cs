...
{
    public class GarmentSampleStockReadModel : ReadModelBase
    {
        public GarmentSampleStockReadModel(Guid identity) : base(identity)
        {
        }
        public string SampleStockNo { get; internal set; }
