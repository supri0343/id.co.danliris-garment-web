...
{
    public class UpdateGarmentServiceSubconExpenditureGoodCommand : ICommand<GarmentServiceSubconExpenditureGood>
    {
    ...
    public class UpdateGarmentServiceSubconExpenditureGoodCommandValidator : AbstractValidator<UpdateGarmentServiceSubconExpenditureGoodCommand>
    {
        public UpdateGarmentServiceSubconExpenditureGoodCommandValidator()
        {
            ...
            RuleForEach(r => r.Items).SetValidator(new GarmentServiceSubconExpenditureGoodItemValueObjectValidator());
        }
    }
