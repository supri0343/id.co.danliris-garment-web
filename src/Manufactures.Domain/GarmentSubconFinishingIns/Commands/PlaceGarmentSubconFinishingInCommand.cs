...
{
    public class PlaceGarmentSubconFinishingInCommand : ICommand<GarmentFinishingIn>
    {
    ...
    class GarmentSubconFinishingInItemValueObjectValidator : AbstractValidator<GarmentSubconFinishingInItemValueObject>
    {
        public GarmentSubconFinishingInItemValueObjectValidator()
        {
