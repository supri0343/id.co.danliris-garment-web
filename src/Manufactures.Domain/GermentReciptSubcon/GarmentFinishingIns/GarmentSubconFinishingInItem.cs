...
namespace Manufactures.Domain.GermentReciptSubcon.GarmentFinishingIns
{
    public class GarmentSubconFinishingInItem : AggregateRoot<GarmentSubconFinishingInItem, GarmentSubconFinishingInItemReadModel>
    {
        ...
        public GarmentSubconFinishingInItem(Guid identity, Guid finishingInId, Guid sewingOutItemId, Guid sewingOutDetailId, Guid subconCuttingId, SizeId sizeId, string sizeName, ProductId productId, string productCode, string productName, string designColor, double quantity, double remainingQuantity, UomId uomId, string uomUnit, string color, double basicPrice, double price) : base(identity)
        {
            ...
            ReadModel = new GarmentSubconFinishingInItemReadModel(Identity)
            {
                FinishingInId = FinishingInId,
                SewingOutItemId = SewingOutItemId,
                SewingOutDetailId= SewingOutDetailId,
        ...
        public GarmentSubconFinishingInItem(GarmentSubconFinishingInItemReadModel readModel) : base(readModel)
        {
        ...
        protected override GarmentSubconFinishingInItem GetEntity()
        {
            return this;
        }
    }
