...
{
    public class GarmentSubconSewingOutItem : AggregateRoot<GarmentSubconSewingOutItem, GarmentSubconSewingOutItemReadModel>
    {
        ...
        public GarmentSubconSewingOutItem(Guid identity, Guid sewingOutId, Guid sewingInId, Guid sewingInItemId, ProductId productId, string productCode, string productName, string designColor, SizeId sizeId,string sizeName, double quantity, UomId uomId, string uomUnit, string color, double remainingQuantity, double basicPrice, double price) : base(identity)
        {
            ...
            ReadModel = new GarmentSubconSewingOutItemReadModel(identity)
            {
                SewingOutId = SewingOutId,
                SewingInId = SewingInId,
                SewingInItemId = SewingInItemId,
        ...
        public GarmentSubconSewingOutItem(GarmentSubconSewingOutItemReadModel readModel) : base(readModel)
        {
        ...
        protected override GarmentSubconSewingOutItem GetEntity()
        {
            return this;
        }
    }
