...
{
	public class GarmentMonitoringProductionStocFlow : AggregateRoot<GarmentMonitoringProductionStocFlow, GarmentMonitoringProductionStockReadModel>
	{
		...
		protected override GarmentMonitoringProductionStocFlow GetEntity()
		{
			return this;
		}
		...
		public GarmentMonitoringProductionStocFlow(GarmentMonitoringProductionStockReadModel readModel) : base(readModel)
		{
