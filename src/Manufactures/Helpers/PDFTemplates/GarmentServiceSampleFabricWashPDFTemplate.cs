...
{
    public class GarmentServiceSampleFabricWashPDFTemplate
    {
        public static MemoryStream Generate(GarmentServiceSampleFabricWashDto garmentSampleFabricWash)
        {
            ...
            Paragraph title = new Paragraph("Sample BB FABRIC WASH / PRINT", bold_font);
            ...
            List<GarmentSampleFabricWashItemVM> itemData = new List<GarmentSampleFabricWashItemVM>();

            foreach (var item in garmentSampleFabricWash.Items)
            {

                foreach (var detail in item.Details)
                {
                    GarmentSampleFabricWashItemVM garmentSampleFabricWashItemVM = new GarmentSampleFabricWashItemVM();
                    garmentSampleFabricWashItemVM.UnitExpenditureNo = item.UnitExpenditureNo;
                    garmentSampleFabricWashItemVM.ProductCode = detail.Product.Code;
                    garmentSampleFabricWashItemVM.ProductName = detail.Product.Name;
                    garmentSampleFabricWashItemVM.DesignColor = detail.DesignColor;
                    garmentSampleFabricWashItemVM.Quantity = detail.Quantity;
                    garmentSampleFabricWashItemVM.UomUnit = detail.Uom.Unit;
                    itemData.Add(garmentSampleFabricWashItemVM);
                }
            }
            ...
            #endregion
            Paragraph qtyPacking = new Paragraph("Jumlah Kemasan : " + garmentSampleFabricWash.QtyPacking + "         "  + "Satuan Kemasan : " + garmentSampleFabricWash.UomUnit, normal_font);
            qtyPacking.SpacingAfter = 5f;
            document.Add(qtyPacking);
            Paragraph remark = new Paragraph("Keterangan : " + garmentSampleFabricWash.Remark, normal_font);
    ...
    public class GarmentSampleFabricWashItemVM
    {
